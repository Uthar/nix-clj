...
, bash, pkg-config, autoconf, cpio, file, which, unzip
, zip, perl, cups, freetype, alsa-lib, libjpeg, giflib, libpng, zlib, lcms2
, libX11, libICE, libXrender, libXext, libXt, libXtst, libXi, libXinerama
, libXcursor, libXrandr, fontconfig, openjdk-bootstrap, fetchpatch
, setJavaClassPath
, headless ? false
...
let
  ...
  openjdk = stdenv.mkDerivation rec {
    ...
    src = fetchFromGitHub {
      ...
      repo = "jdk13u";
      rev = "jdk-${version}";
      hash = "sha256-pRzVwCej1NqmMcID//wxDHerFU4sgV8RlxNDBXOJIu0=";
    };
    ...
    env.NIX_CFLAGS_COMPILE = toString [ "-fcommon" "-Wno-error" ];
